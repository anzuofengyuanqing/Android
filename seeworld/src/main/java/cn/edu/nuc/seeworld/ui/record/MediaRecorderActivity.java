...
import cn.edu.nuc.seeworld.log.Logger;
import cn.edu.nuc.seeworld.ui.BaseActivity;
import cn.edu.nuc.seeworld.ui.record.views.ProgressView;
import cn.edu.nuc.seeworld.ui.record.views.ThemeRadioButton;
import cn.edu.nuc.seeworld.utils.ConvertToUtils;
import cn.edu.nuc.seeworld.utils.NetworkUtils;
...
public class MediaRecorderActivity extends BaseActivity implements OnErrorListener, OnClickListener, OnPreparedListener {
	...
	protected void onResume() {
		if(Config.videofinish==true){
			Config.videofinish=false;
			finish();
		}
		super.onResume();
