package cn.edu.nuc.seeworld.ui.record;
...
import cn.edu.nuc.seeworld.media.MediaPlayer;
import cn.edu.nuc.seeworld.ui.BaseActivity;
import cn.edu.nuc.seeworld.ui.record.views.FrameImageView;
import cn.edu.nuc.seeworld.ui.widget.VideoView;
import cn.edu.nuc.seeworld.utils.IsUtils;
import cn.edu.nuc.seeworld.utils.ResourceUtils;
 ...
 *
 */
public class MediaPreviewActivity extends BaseActivity implements OnClickListener, VideoView.OnPlayStateListener, OnPreparedListener {
...
//						startActivity(intent);
						Config.videofinish=true;
						Config.video_path=mMediaObject.getOutputVideoPath();
						finish();
					} else {
